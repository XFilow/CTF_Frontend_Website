document.addEventListener('DOMContentLoaded', function() {
    ...
    requestCodeForm.addEventListener('submit', async function(event) {
        ...
        try {
            const response = await fetch('https://cryptotradingflow.com/reset-password', {
                method: 'POST',
                headers: {
    ...
    verifyCodeForm.addEventListener('submit', async function(event) {
        ...
        try {
            const response = await fetch('https://cryptotradingflow.com/verify-code', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
                body: JSON.stringify({ code, context: 'password-reset' })
            });
    ...
    newPasswordForm.addEventListener('submit', async function(event) {
        ...
        try {
            const response = await fetch('https://cryptotradingflow.com/new-password', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
